...
#    Mar 03, 2021 07:43:48 AM +0200  platform: Windows NT
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    AA_GUI_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def element_order(self, method='add'):
        ...
        if method=='add':
            ...
            safe = self.safe_prime_checkbox.get()
            if safe==1:
                result = Fp(p1,p).safe_prime_mul_order()
            else:
    ...
    def ec_smooth_curve(self):
        try:
            a = int(self.ec_a_E.get())
            b = int(self.ec_b_E.get())
            p = int(self.ec_p_E.get())
            k = int(self.ec_p_E_1.get())
        except ValueError:
            messagebox.showerror("Values Error", "Please enter valid integers")
            return
        
        C = EllipticCurves(a,b,p)
        pairs = C.smooth_curve(k)

        # Print to GUI
        self.results_TB.insert(tk.END, "Pairs = {\n")
        for i in pairs:
    ...
    def ec_addition(self):
        ...
        p1 = Point(xp,yp,p,a,b)
        p2 = Point(xq,yq,p,a,b)

        # Checks if P is a valid point and the curve defined by a and b
        if not p1.is_on_curve(p1.x,p1.y,p1.p,p1.a,p1.b):
            messagebox.showerror("Values Error", "P is not on the curve defined by a and b")
            return

        # Checks if P and Q are on the same curve
        if not p2.is_on_curve(p2.x,p2.y,p2.p,p1.a,p1.b):
            messagebox.showerror("Values Error", "P and Q are not on the same curve")
            return
    ...
    def ec_inverse(self):
        ...
        # Checks if P is a valid point and the curve defined by a and b
        P = Point(x,y,p,a,b)
        if not P.is_on_curve(x,y,p,a,b):
            messagebox.showerror("Values Error", "P is not on the curve defined by a and b")
            return
    ...
    def ec_generate(self):
        ...
        # Print to GUI
        self.results_TB.insert(tk.END, f"<({x},{y})> = ")
        self.results_TB.insert(tk.END, "{\n")
        for i in elements:
            self.results_TB.insert(tk.END, f"{i},")
        self.results_TB.insert(tk.END, "\n}\n")
    def ec_groups_order(self):
        # Calculates and prints Projective's and Affine's groups orders
        ...
        # Print to GUI
        self.results_TB.insert(tk.END, f"#C = {len(points)}\n")
        self.results_TB.insert(tk.END, f"#Caff = {len(points)+1}\n")
    def ec_identity(self):
        # Prints the identity element of the Projective and Affine groups
        ...
        try:
            ...
            return
        # Print to GUI
        self.results_TB.insert(tk.END, f"e(C) = (0:1:0)\n")
        self.results_TB.insert(tk.END, f"e(Caff) = (0,0)\n")
    def nP(self):
        try:
            a = int(self.ec_a_E.get())
            b = int(self.ec_b_E.get())
        ...
        result = P.nP(n)
        # Print to GUI
        self.results_TB.insert(tk.END, f"{n}({x},{y}) = {result}\n")
    def Hasses_theorem(self):
        try:
            a = int(self.ec_a_E.get())
            b = int(self.ec_b_E.get())
            p = int(self.ec_p_E.get())
        ...
        estimated = p+1
        actual = len(points)+1
        lower_bound = int(-(2*math.sqrt(p)) + (p+1))
        upper_bound = int((2*math.sqrt(p)) + (p+1))

        # Print to GUI
        self.results_TB.insert(tk.END, f"a={a}, b={b}:\n")
        self.results_TB.insert(tk.END, f"-------\n")
        self.results_TB.insert(tk.END, f"Estimated #E(C): {estimated}\n")
        self.results_TB.insert(tk.END, f"Actual #E(C): {actual}\n")
        self.results_TB.insert(tk.END, f"Hasse's Bound: {lower_bound} <= #E(C) <= {upper_bound}\n\n")
    def clear_TB(self):
    ...
    def __init__(self, top=None):
        ...
        #self.field_orders_B.configure(cursor="fleur")
        ...
        self.div_B.place(relx=0.712, rely=0.337, height=34, width=37)
        ...
        self.safe_prime_checkbox = tk.IntVar()
        self.style.map('TCheckbutton',background=[('selected', _bgcolor), ('active', _ana2color)])
        self.safe_prime_CB = ttk.Checkbutton(self.Finite_Fields)
        self.safe_prime_CB.place(relx=0.849, rely=0.499, relwidth=0.14, relheight=0.0, height=21)
        self.safe_prime_CB.configure(variable=self.safe_prime_checkbox)
        #self.safe_prime_CB.configure(takefocus="")
        self.safe_prime_CB.configure(text='''Safe''')
        ...
        self.Label2_3_1_1.place(relx=0.590, rely=0.733, height=20, width=44)
        ...
        self.modulo_E.place(relx=0.603, rely=0.789, height=20, relwidth=0.093)
        ...
        self.Elliptic_Curves.place(relx=0.502, rely=0.014, relheight=0.487
                , relwidth=0.47)
        ...
        self.Label2_4.place(relx=0.137, rely=0.147, height=20, width=34)
        ...
        self.ec_a_E.place(relx=0.137, rely=0.206, height=20, relwidth=0.093)
        ...
        self.Label2_4_1.place(relx=0.274, rely=0.147, height=20, width=34)
        ...
        self.ec_b_E.place(relx=0.274, rely=0.206, height=20, relwidth=0.093)
        ...
        self.Label2_4_1_1.place(relx=0.411, rely=0.147, height=20, width=34)
        ...
        self.ec_p_E.place(relx=0.411, rely=0.206, height=20, relwidth=0.093)
        ...
        self.Label3.place(relx=0.082, rely=0.324, height=28, width=254)
        ...
        self.Label3.configure(text='''Projective and Affine Curves''')

        self.ec_groups_order_B = tk.Button(self.Elliptic_Curves)
        self.ec_groups_order_B.place(relx=0.055, rely=0.531, height=24, width=97)

        self.ec_groups_order_B.configure(activebackground="#ececec")
        self.ec_groups_order_B.configure(activeforeground="#000000")
        self.ec_groups_order_B.configure(background="#d9d9d9")
        self.ec_groups_order_B.configure(command=self.ec_groups_order)
        self.ec_groups_order_B.configure(disabledforeground="#a3a3a3")
        self.ec_groups_order_B.configure(foreground="#000000")
        self.ec_groups_order_B.configure(highlightbackground="#d9d9d9")
        self.ec_groups_order_B.configure(highlightcolor="black")
        self.ec_groups_order_B.configure(pady="0")
        self.ec_groups_order_B.configure(text='''Groups Order''')

        self.ec_identity_B = tk.Button(self.Elliptic_Curves)
        self.ec_identity_B.place(relx=0.384, rely=0.531, height=24, width=97)
        ...
        self.ec_identity_B.configure(command=self.ec_identity)
        ...
        self.ec_show_points_B.place(relx=0.384, rely=0.442, height=24, width=97)
        ...
        #self.ec_show_points_B.configure(cursor="fleur")
        ...
        self.hasses_B.place(relx=0.685, rely=0.531, height=24, width=97)
        ...
        self.hasses_B.configure(command=self.Hasses_theorem)
        ...
        self.hasses_B.configure(text='''Hasse's Bounds''')

        self.Label3_1_1 = tk.Label(self.Elliptic_Curves)
        self.Label3_1_1.place(relx=0.055, rely=0.708, height=28, width=94)
        ...
        self.ec_p_inverse_B.place(relx=0.082, rely=0.885, height=24, width=47)
        ...
        self.ec_p_order_B.place(relx=0.247, rely=0.885, height=24, width=47)
        ...
        self.ec_p_generate_B.place(relx=0.411, rely=0.885, height=24, width=47)
        ...
        self.ec_p_generate_B.configure(command=self.ec_generate)
        ...
        self.ec_p_nP_B.place(relx=0.781, rely=0.767, height=24, width=47)
        ...
        self.ec_p_nP_B.configure(command=self.nP)
        ...
        self.ec_p_q_addition_B_1.place(relx=0.575, rely=0.885, height=24
                , width=47)
        ...
        self.ec_print_points_B.place(relx=0.685, rely=0.442, height=24, width=97)
        ...
        self.ec_p_E_1 = tk.Entry(self.Elliptic_Curves)
        self.ec_p_E_1.place(relx=0.603, rely=0.206, height=20, relwidth=0.093)
        self.ec_p_E_1.configure(background="white")
        self.ec_p_E_1.configure(disabledforeground="#a3a3a3")
        self.ec_p_E_1.configure(font="TkFixedFont")
        self.ec_p_E_1.configure(foreground="#000000")
        self.ec_p_E_1.configure(highlightbackground="#d9d9d9")
        self.ec_p_E_1.configure(highlightcolor="black")
        self.ec_p_E_1.configure(insertbackground="black")
        self.ec_p_E_1.configure(selectbackground="blue")
        self.ec_p_E_1.configure(selectforeground="white")

        self.smooth_curve_B = tk.Button(self.Elliptic_Curves)
        self.smooth_curve_B.place(relx=0.715, rely=0.201, height=24, width=87)
        self.smooth_curve_B.configure(activebackground="#ececec")
        self.smooth_curve_B.configure(activeforeground="#000000")
        self.smooth_curve_B.configure(background="#d9d9d9")
        self.smooth_curve_B.configure(command=self.ec_smooth_curve)
        self.smooth_curve_B.configure(disabledforeground="#a3a3a3")
        self.smooth_curve_B.configure(foreground="#000000")
        self.smooth_curve_B.configure(highlightbackground="#d9d9d9")
        self.smooth_curve_B.configure(highlightcolor="black")
        self.smooth_curve_B.configure(pady="0")
        self.smooth_curve_B.configure(text='''Smooth Curve''')

        self.Label2_4_1_1_1 = tk.Label(self.Elliptic_Curves)
        self.Label2_4_1_1_1.place(relx=0.603, rely=0.147, height=20, width=34)
        self.Label2_4_1_1_1.configure(activebackground="#f9f9f9")
        self.Label2_4_1_1_1.configure(activeforeground="black")
        self.Label2_4_1_1_1.configure(background="#d9d9d9")
        ...
        self.Label2_4_1_1_1.configure(text='''#''')

        self.ec_plot_curve_B = tk.Button(self.Elliptic_Curves)
        self.ec_plot_curve_B.place(relx=0.055, rely=0.442, height=24, width=97)
        self.ec_plot_curve_B.configure(activebackground="#ececec")
        self.ec_plot_curve_B.configure(activeforeground="#000000")
        self.ec_plot_curve_B.configure(background="#d9d9d9")
        self.ec_plot_curve_B.configure(command=self.ec_plot_curve)
        self.ec_plot_curve_B.configure(disabledforeground="#a3a3a3")
        self.ec_plot_curve_B.configure(foreground="#000000")
        self.ec_plot_curve_B.configure(highlightbackground="#d9d9d9")
        self.ec_plot_curve_B.configure(highlightcolor="black")
        self.ec_plot_curve_B.configure(pady="0")
        self.ec_plot_curve_B.configure(text='''Plot Curve''')
