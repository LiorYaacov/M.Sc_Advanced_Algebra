...
#    Feb 25, 2021 10:11:35 AM +0200  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.field_orders_B.configure(command=GUI_support.show_field_orders)
        ...
        self.add_B.configure(command=GUI_support.addition_2)
        ...
        self.hasses_B.place(relx=0.63, rely=0.489, height=24, width=77)
