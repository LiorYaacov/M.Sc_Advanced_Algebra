...
#  Feb 25, 2021 02:55:51 PM +0200  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 777x768+440+132
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    text $top.tex63 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground blue \
        -selectforeground white -width 754 -wrap word 
    $top.tex63 configure -font "TkTextFont"
    $top.tex63 insert end text
    vTcl:DefineAlias "$top.tex63" "results_TB" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $top.tex63 \
        ...
        -height 0 -relheight 0.393 -anchor nw -bordermode ignore 
    place $top.but64 \
